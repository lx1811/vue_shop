    ...
    <el-card>
        ...
        <el-tabs v-model="tabsActiveName" @tab-click="tabsHandleClick">
            <el-tab-pane label="动态参数" name="many">
                <el-button type="primary" size="mini" :disabled="isBtnDisable" style="margin-bottom:15px;">添加参数</el-button>
            ...
            <el-tab-pane label="静态属性" name="only">
                <el-button type="primary" size="mini" :disabled="isBtnDisable" style="margin-bottom:15px;">添加属性</el-button>
