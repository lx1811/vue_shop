                ...
                <el-table :data="paramsData.many" border stripe>
                    <el-table-column type="expand">
                        <template slot-scope="scope">
                            <el-tag type="primary" v-for="(item,index) in attrTags(scope.row.attr_vals)" :key="index" closable>{{item}}</el-tag>
                            <el-input
                            class="input-new-tag"
                            v-if="createTagVisible"
                            v-model="newTagValue"
                            ref="newTagRef"
                            size="small"
                            ...
                            <el-button v-else class="button-new-tag" size="small" @click="createTagVisible=true">+ New Tag</el-button>
                        </template>
                    </el-table-column>
