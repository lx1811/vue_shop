    ...
    <el-card>
        ...
        >
            <el-form :model="editForm" :rules="rules" ref="editFormRef" label-width="100px">
                <el-form-item :label="tabsActiveName=='many'?'新参数名称':'新属性名称'" prop="attr_name">
    ...
    methods:{
        ...
        editParams(){
            this.$refs.editFormRef.validate(async valid=>{
                ...
                const {data:res} = await this.$http.get(`categories/${this.selectedCateKeys[this.selectedCateKeys.length-1]}/attributes/${id}`,{
                    params:{
                        attr_sel:this.tabsActiveName,
                        attr_vals:this.editForm.new_attr_name
                    }
                })
                console.log(res)
            })
