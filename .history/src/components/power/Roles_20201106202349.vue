<template>
  <div>
    ...
    <el-card>
        ...
        >
            <el-tree :data="rightsList" :props="{label:'authName',children:'children'}" show-checkbox node-key="id" default-expand-all :default-checked-keys="defKeys" ref="treeRef">

            </el-tree>
            <span slot="footer" class="dialog-footer">
                <el-button @click="setRightDialogVisible = false">取 消</el-button>
                <el-button type="primary" @click="allotRights">确认分配</el-button>
            </span>
        </el-dialog>
...
export default {
    ...
    methods:{
        ...
        allotRights(){
            ...
            console.log(keys)
            let idStr = keys.join(',')
            const {data:res} = this.$http.post(`roles/${this.roleId}/rights`,{}) 
        }
    }
}
