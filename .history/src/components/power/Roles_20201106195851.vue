  ...
  <div>
    ...
    <el-card>
        ...
        <el-table :data="roleList" border stripe>
            ...
            <el-table-column label="操作" width="300px">
                <template slot-scope="scope">
                    ...
                    <el-button type="warning" icon="el-icon-setting" size="mini" @click="showRightDialog">分配权限</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-dialog
        ...
        <el-dialog
            ...
            width="50%"
        >
            <el-tree :data="rightsList" :props="{label:'authName',children:'children'}" show-checkbox node-key="id" default-expand-all default-expanded-keys="defKeys">
