        ...
        <el-table :data="roleList" border stripe>
            <el-table-column type="expand">
                <template slot-scope="scope">
                    <el-row v-for="(item_1,index_1) in scope.row.children" :key="item_1.id" :class="['bdbottom',{'bdtop':index_1==0}]">
                        <el-col :span="5" style="display:flex;align-item:center;">
                            <el-tag>{{item_1.authName}}</el-tag>
                            <i class="el-icon-caret-right"></i>
                        </el-col>
                        <el-col :span="19">
                            <el-row v-for="(item_2,index_2) in item_1.children" :key="item_2.id" :class="{'bdbottom':index_2!=item_1.children.length-1}">
                                <el-col :span="6">
                                    <el-tag type="success">{{item_2.authName}}</el-tag>
                                    <i class="el-icon-caret-right"></i>
                                </el-col>
                                <el-col :span="18">
                                    <el-tag type="warning" v-for="(item_3,index_3) in item_2.children" :key="item_3.id">{{item_3.authName}}</el-tag>
                                </el-col>
                            </el-row>
                        </el-col>
                    </el-row>
